 ...
 * @LastEditTime: 2020-03-10 11:13:30
 * @LastEditors: aiyoudiao
 * @FilePath: \web-end\my-robot\src\app\core\controller\bot\friend-reqeust-controller.ts
 */
...
// 好友添加监听回调
export async function friendReqeust(friendship) {
  let logMsg;
  try {
