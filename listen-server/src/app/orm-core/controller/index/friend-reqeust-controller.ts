/*
 * @Descripttion: 添加好友请求消息的监听
 * @version: 1.0.0
 * @Author: aiyoudiao
 * @Date: 2020-03-10 08:59:45
 * @LastEditTime: 2020-03-20 14:10:29
 * @LastEditors: aiyoudiao
 * @FilePath: \my-robot\src\app\orm-core\controller\friend-reqeust-controller.ts
 */
...
// 好友添加监听回调
export async function friendReqeust(friendship: Friendship) {
  let logMsg;
  try {
