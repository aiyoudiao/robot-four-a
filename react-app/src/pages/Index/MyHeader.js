...
const ShowQRCodeModal = LoadableComponent (import ('./ShowQRCodeModal'));
...
class MyHeader extends React.Component {
  constructor (props) {
    ...
    this.state = {
      ...
      qrcodeVisible: false, //控制显示二维码的模态框
    };
  }
  /**
     * 切换侧边栏的折叠和展开
      ...
      <div style={{background: '#fff', padding: '0 16px'}}>
        ...
        <div style={styles.headerRight}>
          ...
          <div style={styles.headerItem}>
            ...
            <img
              width={24}
              src={require (`../../assets/images/${theme}.svg`)}
              alt=""
              onClick={this.changeTheme}
            />
          </div>
            ...
            <Menu mode="horizontal" selectable={false}>
              ...
              >
                <MenuItemGroup title="用户中心">
                  <Menu.Item
                    key={1}
                    onClick={() => this.toggleInfoVisible (true)}
                  >
                    <Icon type="user" />编辑个人信息
                  </Menu.Item>
                  <Menu.Item
                    key={77}
                    onClick={() => this.togglePasswordVisible (true)}
                  >
                    <Icon type="edit" />修改密码
                  </Menu.Item>
                ...
                <MenuItemGroup title="设置中心">
                  <Menu.Item key={3} onClick={this.toggleFullscreen}>
                    <Icon
                      type={isFullscreen ? 'fullscreen-exit' : 'fullscreen'}
                    />
                    切换全屏
                  </Menu.Item>
                  <Menu.Item key={4} onClick={this.showQRCode}>
                    <Icon type="qrcode" />二维码
                  </Menu.Item>
                  {/* <Menu.Item key={4} onClick={this.resetColor}>
                    <Icon type="ant-design" />恢复默认主题
                  </Menu.Item> */}
                </MenuItemGroup>
              </SubMenu>
            </Menu>
        ...
        <EditInfoModal
          toggleVisible={this.toggleInfoVisible}
          visible={infoVisible}
        />
        <EditPasswordModal
          toggleVisible={this.togglePasswordVisible}
          visible={passwordVisible}
        />
        <ShowQRCodeModal
          toggleVisible={this.showQRCode}
